...
func main() {
	...
	for i := 1; i <= 1; i++ {
		...
		// Парсинг статистики
		var avg, stdev, max, reqsPerSec, latency, latency50, latency75, latency90, latency95, latency99, http1xx, http2xx, http3xx, http4xx, http5xx, otherHTTP, throughput string
